...
# enc 8.5.0 - CREATED BY RAPIDSLAYER101 (Scott Bree)  # THIS IS ENC 9.0 WIP
...
def get_file_size(file):
    ...
    if file_size_kb > 9999:
        ...
        if file_size_mb > 500:
            print("This file is not supported due to its large size, the max is 500MB")
            return "NOTSUP"
